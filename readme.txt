In this reposatoray we try to explore the internals of redux,by creating our own version of redux

We will be creating the following 
1)Store
2)Reducer

Sample app->To do app,providing functions for adding,toggeling,deleting a todo.
